 ...
 */
        TEST(EpipolarGeometryTest, minDepthProjectionXTranslate1) {
            ...
            EpipolarGeometry<float> epigeo(K, K.inverse(), K, K.inverse());
 ...
 */
        TEST(EpipolarGeometryTest, maxDepthProjectionIdentity) {
            ...
            EpipolarGeometry<float> epigeo(K, Kinv, K, K.inverse());
 ...
 */
        TEST(EpipolarGeometryTest, disparityToDepthTest1) {
            ...
            // Depth from camera 1.
            EpipolarGeometry<float> epigeo1(K, Kinv, K, Kinv);
            ...
            // Depth from camera 2.
            EpipolarGeometry<float> epigeo2(K, Kinv, K, Kinv);
 ...
 */
        TEST(EpipolarGeometryTest, projectTest1) {
            ...
            EpipolarGeometry<float> epigeo(K, Kinv, K, Kinv);
